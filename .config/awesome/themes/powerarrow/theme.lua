   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("#343434", "#5700FF"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#5700FF"),
            arrow("#5700FF", "#000d1a"),
            ...
            arrow("#000d1a", "#FF00D9"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), "#FF00D9"),
            --arrow("#FF00D9", "#4B3B51"),
            ...
            arrow("#FF00D9", "#9700FF"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#9700FF"),
            arrow("#9700FF", "#FF1A95"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#FF1A95"),
            arrow("#FF1A95", "#D700FF"),
            wibox.container.background(wibox.container.margin(clock, dpi(4), dpi(8)), "#D700FF"),
            arrow("#D700FF", "alpha"),
            --]]
            s.mylayoutbox,
        },
